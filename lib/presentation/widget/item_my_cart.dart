...
class ItemMyCart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Row(
      ...
      children: [
        CustomImage(height: 160, width: 200,paddingFromTop: 0, paddingFromRight:20,image: 'https://img.freepik.com/free-photo/vintage-furniture_74190-346.jpg?size=626&ext=jpg&uid=R75041609&ga=GA1.2.1417712406.1684331786&semt=ais'),
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
